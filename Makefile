...
build:
	...
	cd ./bff-desktop/ && \
		docker build -t soobinrho/17647-bookstore-bff-desktop:latest -t soobinrho/17647-bookstore-bff-desktop:$(git rev-parse --short HEAD) .
	cd ./bff-mobile/ && \
...
test:
	...
	echo 'Port 8000: dev-bookstore-bff-desktop'
